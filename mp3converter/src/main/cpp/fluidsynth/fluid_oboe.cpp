...
{
    fluid_settings_register_int(settings, "audio.oboe.id", 0, 0, 0x7FFFFFFF, 0, NULL, NULL);

    fluid_settings_register_str(settings, "audio.oboe.sharing-mode", "Shared", 0, NULL, NULL);
    ...
    fluid_settings_register_str(settings, "audio.oboe.performance-mode", "None", 0, NULL, NULL);
...
int delete_fluid_oboe_audio_driver(fluid_audio_driver_t *p)
{
