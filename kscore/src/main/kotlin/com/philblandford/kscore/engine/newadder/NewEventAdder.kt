...
import com.philblandford.kscore.engine.newadder.util.getLevel
import com.philblandford.kscore.engine.newadder.util.strip
...
data class EventDestination(
  ...
  val newSubAdder: NewSubAdder? = null
)
...
object GenericSubAdder : NewSubAdder
...
interface NewEventAdderIf {
  ...
  fun addEvent(
    ...
    return getDestination(eventType)?.let { destination ->
      val adder = destination.newSubAdder ?: GenericSubAdder
