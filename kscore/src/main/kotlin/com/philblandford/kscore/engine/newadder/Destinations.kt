...
import com.philblandford.kscore.engine.newadder.subadders.*
...
internal val destinations = mapOf(
  ...
  EventType.COMPOSER to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
  ...
  EventType.FERMATA to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
  ...
  EventType.LYRICIST to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
  EventType.META to EventDestination(listOf(ScoreLevelType.SCORE), MetaSubAdder),
  EventType.NAVIGATION to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
  ...
  EventType.REHEARSAL_MARK to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
  ...
  EventType.SUBTITLE to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
  EventType.TEMPO to EventDestination(listOf(ScoreLevelType.SCORE), TempoSubAdder),
  EventType.TEMPO_TEXT to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
  ...
  EventType.TITLE to EventDestination(listOf(ScoreLevelType.SCORE), GenericSubAdder),
