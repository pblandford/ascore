...
internal class MetaInsertViewModel(
    insertMetaEvent: InsertMetaEvent,
    ...
    override val initEventType: EventType = EventType.TITLE
}

internal class FooterInsertViewModel(
    insertMetaEvent: InsertMetaEvent,
    getMetaEvent: GetMetaEvent,
    updateInsertItem: UpdateInsertItem,
    getFonts: GetAvailableFonts,
    ...
    override val initEventType: EventType = EventType.FOOTER_LEFT
}

internal abstract class MetaInsertCommonViewModel(
    ...
    ScoreInsertViewModel<MetaInsertModel, MetaInsertInterface>(), MetaInsertInterface {

    abstract val initEventType: EventType

    override suspend fun initState(): Result<MetaInsertModel> {
        setEventType(initEventType)
        listenForUpdates()
    ...
    override fun setEventType(eventType: EventType) {
        ...
        updateInsertItem {
            copy(
                eventType = eventType,
                params = (event?.params ?: paramMapOf()) + (EventParam.FONT to font)
            )
        }
    }
